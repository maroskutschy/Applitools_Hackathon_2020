...
public class GeneralStepDefinitions {
    ...
    public void closeBrowser(Scenario scenario) {
        ...
        Assert.assertTrue("One or more elements were not correctly displayed/hidden, check statuses Fail in 'Traditional-V1-TestResults.txt' in the target folder of the project", collectedResultOfValidation);
    }
