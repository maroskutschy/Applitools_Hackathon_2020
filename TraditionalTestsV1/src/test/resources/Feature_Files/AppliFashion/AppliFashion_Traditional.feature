...
#    Then I make Applitools Visual Test validation running via UltraFast Grid with test name: "Task 3" and step name: "Product Details test"
  ...
  Scenario Outline: Task 1 - Cross-Device Elements Test
    ...
    Then I validate after search for black colors if all relevant elements on the Home page for task No "2" and "<browser>" browser and "<width>" viewport width and "<height>" viewport height and "<device type>" device type are correctly displayed
